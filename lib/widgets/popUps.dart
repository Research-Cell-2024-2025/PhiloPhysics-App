...
Future<void> onDocDelete({required String docID,required String moduleID,required String section,required BuildContext context}) {
    return showDialog(
      context: context,
...
//   }
  ...
  void showResultDialog(BuildContext context, String result) {
   ...
   Future<void> onDelete({String? id,String? section,required BuildContext context}) {
    return showDialog(
      context: context,
      builder: (context) => new AlertDialog(
        title: new Text('Are you sure?'),
...
Future<void> onDeleteVideo({String? id,String? section,required BuildContext context,required Map<dynamic, dynamic> videoDetails,}) {
  return showDialog(
    context: context,
    builder: (context) => new AlertDialog(
      title: new Text('Are you sure?'),
      ...
      actions: <Widget>[
        ...
        new GestureDetector(
          onTap: () async{
            onVideoDelete(section:section! ,moduleID: id!,context: context,videoDetails: videoDetails);
            Navigator.of(context).pop(false);
          },
          child: Text("YES" ,style: TextStyle(fontSize: 18),),
        ),
