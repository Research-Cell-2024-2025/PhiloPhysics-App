...
Future<void> addVideo({
  ...
  // late String thumbnailDownloadUrl;

  try {
    // var videoStorageReference =
    // FirebaseStorage.instance.ref().child("$section/$moduleID/videos/$uniqueID");
    // var videoUploadTask = videoStorageReference.putFile(doc);
    // await videoUploadTask.whenComplete(() async {
    //   await videoStorageReference.getDownloadURL().then((fileURL) {
    //     videoDownloadUrl = fileURL;
    //   });
    // });
    //
    // var thumbnailStorageReference =
    // FirebaseStorage.instance.ref().child("$section/$moduleID/thumbnails/$uniqueID");
    // var thumbnailUploadTask = thumbnailStorageReference.putFile(thumbnail);
    // await thumbnailUploadTask.whenComplete(() async {
    //   await thumbnailStorageReference.getDownloadURL().then((fileURL) {
    //     thumbnailDownloadUrl = fileURL;
    //   });
    // });
